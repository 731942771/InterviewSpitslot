...
public class PhoneinfoUtil {
	...
	private static void getTM() {
		tm = (TelephonyManager) RootApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
	}
	...
	public static String getAvailMemory() {// 获取android当前可用内存大小
		...
		ActivityManager am = (ActivityManager) RootApplication.getAppContext().getSystemService(Context.ACTIVITY_SERVICE);
		MemoryInfo mi = new MemoryInfo();
		am.getMemoryInfo(mi);
		// mi.availMem; 当前系统的可用内存

		return Formatter.formatFileSize(RootApplication.getAppContext(), mi.availMem);// 将获取的内存大小规格化
	}
	...
	public static String getTotalMemory() {
		...
		return Formatter.formatFileSize(RootApplication.getAppContext(), initial_memory);// Byte转换为KB或者MB，内存大小规格化
	}
